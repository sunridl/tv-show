...
app.add_url_rule('/', view_func=views.global_index, methods=['GET', 'POST'])
...
app.add_url_rule('/users/<int:user_id>/delete', view_func=views.user_delete, methods=['GET', 'POST'])
...
app.add_url_rule('/channels_list/<int:channels_list_id>/delete', view_func=views.channels_list_delete, methods=['GET', 'POST'])
...
app.add_url_rule('/channels/<int:channel_id>/delete', view_func=views.channel_delete, methods=['GET', 'POST'])
...
app.add_url_rule('/shows/<int:show_id>/delete', view_func=views.show_delete, methods=['GET', 'POST'])
